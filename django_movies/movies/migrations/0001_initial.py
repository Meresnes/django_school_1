    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.category', verbose_name='Категрия')),
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.Actor', verbose_name='режиссёр')),
                ('generes', models.ManyToManyField(to='movies.Genere', verbose_name='жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
